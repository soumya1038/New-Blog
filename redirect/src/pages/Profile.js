...
import { FaCamera, FaKey, FaTrash, FaEye, FaEyeSlash, FaCopy, FaPlus, FaEdit, FaFacebook, FaInstagram, FaYoutube, FaGithub, FaLinkedin, FaGlobe, FaArrowLeft, FaCheckCircle, FaTimesCircle, FaExclamationCircle, FaArrowRight, FaTimes, FaShare, FaWhatsapp, FaRedo, FaPalette } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen theme-page-bg py-8">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="theme-panel rounded-3xl shadow-xl p-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h2 className="text-2xl font-bold" style={{ color: isDark ? 'var(--article-text-dark)' : 'var(--article-text)', fontFamily: 'var(--article-font-display)' }}>{user?.username}</h2>
      ...
      {modal.show && (
        <div className="fixed inset-0 theme-modal-overlay flex items-center justify-center z-[60] p-4">
          <div className="theme-modal-card rounded-lg p-6 max-w-md w-full shadow-2xl animate-fadeIn">
            ...
            <form onSubmit={handleSaveStatus}>
              ...
              <div className="flex gap-2 mt-6">
                ...
                <button
                  ...
                  className="px-4 py-2 theme-soft-button text-sm rounded-lg transition"
                >
                  {t('Cancel')}
                </button>
              </div>
          ...
          <div className="relative w-full max-w-md h-full flex items-center justify-center">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
              ...
              {!statusForm.imagePreview && (
                ...
                >                  <FaPalette /> {t('Regenerate Background')}
                </button>
              )}
              <button
                onClick={async (e) => {
          ...
          <div className="theme-modal-card rounded-lg p-6 max-w-md w-full">
            ...
            <form onSubmit={async (e) => {
              ...
              <div className="flex gap-3">
                ...
                <button type="button" onClick={() => { setShowForgotCodeModal(false); setForgotCode(''); setForgotCodeError(''); }} className="flex-1 theme-soft-button px-6 py-2 rounded-lg">{t('Cancel')}</button>
              </div>
            </form>
          </div>
        </div>
      ...
      {showDeleteCodeModal && (
        <div className="fixed inset-0 theme-modal-overlay flex items-center justify-center z-50 p-4">
          <div className="theme-modal-card rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-red-600 font-semibold mb-4 flex items-center gap-1"><FaExclamationCircle className="text-red-500" /> {t('This action is permanent!')}</p>
