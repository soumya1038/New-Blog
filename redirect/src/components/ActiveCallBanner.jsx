    ...
    <div className="bg-green-600 text-white px-4 py-3 flex items-center justify-between shadow-lg">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full overflow-hidden bg-white">
          <img
            src={remoteUser?.profileImage || `https://ui-avatars.com/api/?name=${encodeURIComponent(remoteUser?.fullName || 'User')}&background=0D8ABC&color=fff`}
        ...
        <div>
          ...
          <p className="text-sm text-green-100">{remoteUser?.fullName}</p>
        </div>
      </div>
