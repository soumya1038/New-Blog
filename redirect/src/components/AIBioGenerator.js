      ...
      {showModal && (
        <div className="fixed inset-0 theme-modal-overlay flex items-center justify-center z-50 p-4">
          <div className="theme-modal-card rounded-2xl p-6 max-w-md w-full">
            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-4">AI Bio Generator</h3>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-[var(--border-default)] rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-purple-500 bg-[var(--surface-card)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)]"
            />
            ...
            />
              ...
              className="w-full px-4 py-2 border border-[var(--border-default)] rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-purple-500 bg-[var(--surface-card)] text-[var(--text-primary)]"
            >
